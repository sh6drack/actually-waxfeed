      ...
      <div className="p-4">
        {isSubscriber ? (
          ...
          <div>
            ...
            <Link
              href="/radar"
              className="flex items-center justify-center gap-2 w-full py-2.5 border border-[--border] text-[--foreground] text-center text-[10px] tracking-[0.15em] uppercase hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)] transition no-underline mb-2"
            >
