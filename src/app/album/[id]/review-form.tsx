      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          <label className="block text-sm text-[#888]">
            Review {textRequired ? <span className="text-[#ffd700]">*</span> : "(optional)"}
          </label>
          <Tooltip content="Share your thoughts about the album. For the first 100 reviews, this is required to ensure quality. After that, it's optional.">
            <svg className="w-4 h-4 text-[#666] cursor-help" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex justify-between mt-1">
          <p className={`text-xs ${textRequired && !textValid ? 'text-amber-500' : 'text-[#666]'}`}>
          ...
          {!existingReview && (
            <p className="text-xs text-[#666]">+5 Wax for reviewing</p>
          )}
        </div>
      </div>
