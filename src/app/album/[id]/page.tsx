...
export default async function AlbumPage({ params }: Props) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      {/* Main Grid - Album Info + Tracklist side by side */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-12">
        {/* Album Header - takes 2 columns */}
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8">
          {/* Cover Art */}
        ...
        {/* Tracklist - aligned with header at top */}
        <div>
