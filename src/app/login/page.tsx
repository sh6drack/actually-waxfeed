    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <button
          ...
          className="w-full bg-white text-black py-4 px-6 font-bold text-lg hover:bg-gray-100 transition-colors flex items-center justify-center gap-3 mb-3"
        >
        ...
        <button
          ...
          className="w-full bg-[#24292e] text-white py-4 px-6 font-bold text-lg hover:bg-[#2f363d] transition-colors flex items-center justify-center gap-3 mb-6"
        >
